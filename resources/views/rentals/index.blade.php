    ...
    <x-slot name="header">
        <div class="flex flex-wrap justify-between items-center gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('rentals.export', request()->query()) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700">
                    {{ __('Download Excel') }}
                </a>
                <a href="{{ route('rentals.export-pdf', request()->query()) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700">
                    {{ __('Download PDF') }}
                </a>
