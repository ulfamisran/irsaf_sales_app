<x-app-layout>
    <x-slot name="title">{{ __('Tambah Kategori Pemasukan') }}</x-slot>
    <x-slot name="header">
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto">
            <div class="card-modern overflow-hidden">
                <div class="p-6">
                    <form method="POST" action="{{ route('income-categories.store') }}" class="space-y-4">
                        @csrf
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input id="affects_profit_loss" type="checkbox" name="affects_profit_loss" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('affects_profit_loss', '1') ? 'checked' : '' }}>
