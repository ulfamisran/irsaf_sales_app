...
class SaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'trade_ins.*.processor' => ['nullable', 'string', 'max:255'],
            'trade_ins.*.ram' => ['nullable', 'string', 'max:255'],
            'trade_ins.*.storage' => ['nullable', 'string', 'max:255'],
            'trade_ins.*.color' => ['nullable', 'string', 'max:255'],
